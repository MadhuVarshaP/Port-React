  ...
  return (
    <div className='flex flex-col justify-center items-center my-[40px]'>
        ...
        <div className='m-[20px] border-solid border-2 border-black rounded-2xl h-[500px] w-[700px] flex flex-col justify-center'>
            ...
            <Link to='/3' type='submit' className='bg-[#2DA2B5] p-[10px] rounded-3xl  hover:text-white  w-[120px] flex justify-center'> Previous </Link>
            <Link to='/5' type='submit' className='bg-[#2DA2B5] p-[10px] rounded-3xl  hover:text-white  w-[120px] flex justify-center'> Let's Ship </Link>
            </div>
