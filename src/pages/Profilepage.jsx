  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-center'>
        ...
        <Link to='/changeprofile' type='submit' className='bg-[#2DA2B5] my-[15px] h-[40px] rounded-3xl  hover:text-white  w-[160px] flex justify-center items-center'>Change Profile</Link>
        ...
        <Link to='/1' type='submit' className='bg-[#2DA2B5] h-[40px] rounded-3xl  hover:text-white  w-[160px] flex justify-center items-center'>Change</Link>
      </div>
    </div>
  )
}
